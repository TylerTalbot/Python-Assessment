...
TitleLabel = tk.Label(root, text="Please enter your information: ", font=("sans-serif", 14, "bold"), bg="orange")
...
TitleLabel = tk.Label(root, text="There are 500 items for each product", font=("sans-serif", 14, "bold"), bg="orange")
TitleLabel.grid(row=1, column=0, columnspan=4, pady=10)

#------------------------------------------------------------------------------------------------------------------------------------------------------
# First Name

tk.Label(root, text="Name: ", fg="black", bg="orange", font=("sans-serif", 14, "bold")).grid(row=2, column=1, padx=10, pady=5)
NameEntry = tk.Entry(root, bg="white", width=15)
NameEntry.grid(row=3, column=1, padx=10, pady=5)
NameLabel = tk.Label(root, text="", fg="grey", font=("sans-serif", 12), bg="orange")
...
tk.Label(root, text="Last Name: ", fg="Black", bg="orange", font=("sans-serif", 14, "bold")).grid(row=2, column=2, padx=10, pady=5)
LastNameEntry = tk.Entry(root, bg="white", width=15)
LastNameEntry.grid(row=3, column=2, padx=10, pady=5)
LastNameLabel = tk.Label(root, text="", fg="grey", font=("sans-serif", 12), bg="orange")
LastNameLabel.grid(row=10, column=2, padx=10, pady=2)

#------------------------------------------------------------------------------------------------------------------------------------------------------
# This is my input for the user to input how much of an item they want

amount_label = tk.Label(root, text="Item Amount:", fg="black", bg="orange", font=("Sans serif", 14, "bold" )).grid(row=4, column=1, padx=10, pady=5)
ItemEntry = tk.Entry(root, bg="white", width=15)
ItemEntry.grid(row=5, column=1, padx=10, pady=5)
ItemLabel = tk.Label(root, text="", fg="grey", font=("sans-serif", 12), bg="orange")
...
tk.Label(root, text="Select Item: ", fg="black", bg="orange", font=("sans-serif", 14, "bold")).grid(row=4, column=2, padx=10, pady=5)
